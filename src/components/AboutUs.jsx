  ...
  return (
    <div>
      ...
      <div className="bg-red-600 pt-10 relative z-10">
        <h1 className="text-center pb-4 font-bold font-serif text-2xl lg:text-4xl">
          Light Ads Neon
        </h1>
      ...
      <div className="bg-[#1c1917]">
        <h1 className="text-red-600 text-center pb-6 font-bold font-serif text-2xl lg:text-4xl">
          Contacts
        </h1>
        <MapContainer
          center={position}
